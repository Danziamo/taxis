...
public class OrderActivityFragment extends ActionBarActivity implements View.OnClickListener {
    ...
    public static OrderActivityFragment newInstance() {
        return new OrderActivityFragment();
    }
    ...
    private void InitListView(JSONArray array) {
        ...
        try {
            ...
            ClientAdapter adapter = new ClientAdapter(OrderActivityFragment.this, list);
    ...
    public class FetchOrderTask extends AsyncTask<Void, Void, JSONArray> {
        ...
        protected void onPostExecute(JSONArray result) {
            ...
            if (result != null) {
                ...
                Toast.makeText(OrderActivityFragment.this, "Не удалось получить данные с сервера", Toast.LENGTH_LONG).show();
            }
        }
